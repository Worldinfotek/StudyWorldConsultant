...
import '../../kyc_bank_details/kyc_bank_detail_view.dart';
import '../../models/kyc_bank_detail_model.dart';

class KycBankDetailCard extends StatelessWidget {
  final KycBankDetailModel record;
  final VoidCallback onEdit;
  final VoidCallback onDelete;

  const KycBankDetailCard({
    super.key,
  ...
  Widget build(BuildContext context) {
    return InkWell(
      ...
      onTap: () {
        showDialog(
          context: context,
          builder: (_) => KycBankDetailViewDialog(record: record),
        );
      },
      child: Container(
