...
class ShareToProcessingDialog extends StatefulWidget {
  ...
  @override
  State<ShareToProcessingDialog> createState() => _ShareToProcessingDialogState();
}
        ...
        child: Column(
          ...
          children: [
            ...
            CheckboxListTile(
              ...
              onChanged: (val) => setState(() => _shareToProcessing = val ?? false),
            ...
            Row(
              ...
              children: [
                OutlinedButton(
                  ...
                  child: Text(
                    'Close',
                    style: TextStyle(color: AppColors.onboardingDescription, fontSize: 15.sp),
                  ),
                ),
                SizedBox(width: 2.w),
                ElevatedButton(
